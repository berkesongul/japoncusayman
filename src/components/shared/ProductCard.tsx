...
export function ProductCard({ product }: ProductCardProps) {
    ...
    return (
        <motion.div
            ...
            className="h-full"
        >
            <Card className="group h-full overflow-hidden flex flex-col transition-all hover:shadow-xl hover:shadow-primary/10 hover:border-primary/50 bg-card rounded-xl">
